...
@Component({
  selector: 'pe-data-grid-small-close-icon',
  template: `
    <svg xmlns="http://www.w3.org/2000/svg" [style.width]="width" [style.height]="height" viewBox="0 0 16 16">
...
export class PeDataGridSmallCloseIconComponent {
  @Input() rotation = 0;
  @Input() width = 20;
  @Input() height = 20;
}
